...
class projectManagerController extends Controller
{
    ...
    public function matrial_requestdata(request $request)
    {
        ...
        $matrial_request = $matrial_request->select(['id', 'ref', 'subject', 'date', 'user_id', 'status']);


        if($request->from && $request->to){
            $matrial_request = $matrial_request->whereBetween('date',[$request->from, $request->to]);
        }
        ...
        return response()->json($matrial_request);
    }
    ...
    public function subcontractordata(request $request)
    {
        ...
        // $subcontractor = $subcontractor->select(['id', 'ref', 'subject', 'date', 'user_id', 'status']);

        if($request->from){
            $subcontractor = $subcontractor->whereBetween('date',[$request->from, $request->to]);
        }
    ...
    public function summary(request $request)
    {
        ...
        if($request->from){
            $report = $report->whereBetween('date',[$request->from, $request->to]);
        }
    ...
    public function podata(request $request)
    {
        ...
        if($request->from){
            $Purchase_order = $Purchase_order->whereBetween('date',[$request->from, $request->to]);
        }

     


        // $Purchase_order = $Purchase_order->select(['id','ref','subject','date','user_id','status']);
    ...
    public function petty_cashdata(request $request)
    {
        ...
        if($request->from){
            $petty_cash = $petty_cash->whereBetween('date',[$request->from, $request->to]);
        }
        ...
        // $petty_cash = $petty_cash->select(['id','ref','subject','date','user_id','status']);
    ...
    public function index()
    {
        ...
        return Inertia::render('User/DCC/Index', [
        ...
        return view('ProjectManager.dcc')->with([
            'purchase_orderworkflow' => $purchase_orderworkflow, 'subcontrctorworkflow' => $subcontrctorworkflow,
            'matrial_requestworkflow' => $matrial_requestworkflow,
            'petty_cashworkflow' => $petty_cashworkflow,
            'projects' => $projects
    ...
    {
        $projects = auth()->user()->projectmanager()->select(['id', 'projectmanager_id', 'name'])->get();
        return Inertia::render('User/ProjectTimeSheet/Index', ['projects' => $projects]);
...
*/
    ...
    {
        $projects = auth()->user()->projectmanager()->select(['id', 'projectmanager_id', 'name'])->get();
        return Inertia::render('User/Laborers/Index', ['projects' => $projects]);
    ...
    public function edit_laborer(User $User)
    {
        $data = $User->contract;
        $projects = auth()->user()->projectmanager()->select(['id', 'projectmanager_id', 'name'])->get();
        return Inertia::render('User/Laborers/Edit', ['data' => $User, 'projects' => $projects]);
    ...
    {
        $projects = auth()->user()->projectmanager()->select(['id', 'projectmanager_id', 'name'])->get();
        return Inertia::render('User/Laborers/Create', ['projects' => $projects]);
    ...
    public function add_laborer(request $request)
    {
        ...
        return redirect()->route('projectmanager.index_laborer', ['message' => 'Created successfully']);
...
*/
    ...
    public function update_laborer(request $request, User $User)
    {
        ...
        $User->update();
        return redirect()->route('projectmanager.index_laborer', ['message' => 'Modified successfully']);
