...
class taskManagerController extends Controller
{
    ...
    public function editTask(task $task)
    {
        ...
        return Inertia::render('Management/Tasks/Edit', ['data' => $task]);
    ...
    {
        return Inertia::render('Management/Tasks/Create');
    ...
    public function PostTask(request $request)
    {
        ...
        return redirect()->route('task.index', ['message' => 'Created successfully']);
    }

    public function index()
    {
        return Inertia::render('Management/Tasks/Index');
