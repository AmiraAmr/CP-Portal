...
class siteController extends Controller
{
    ...
    public function presitereturn(request  $request)
    {
        ...
        return Inertia::render('User/SiteRequest/Preview');
    ...
    public function insrting(request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request, $data) {
                ...
                return redirect()->route('user.index_site_inv', ['message' => 'Created successfully']);
            });
        } catch (Exception $e) {
            return $e;
        }
    ...
    public function sitereturn($site)
    {
        if (is_numeric($site)) {
            ...
            if (!empty($data)) {
                return Inertia::render('User/SiteRequest/Preview', ['data' => $data]);
                return view('site.preview')->with(['dataFromController' => $data]);
            }
        }
    }
