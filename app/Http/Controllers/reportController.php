...
class reportController extends Controller
{
    ...
    public function stockPage()
    {
        ...
        return Inertia::render('Management/Reports/Stock', ['projects' => $projects]);
...
*/
    ...
    {
        return Inertia::render('Management/Reports/ProjectTimesheet');
...
*/
    ...
    public function construction()
    {
        ...
        return Inertia::render('Management/Reports/ConstructionDepartment', ['bid_value' => $bid_value]);
    ...
    {
        return Inertia::render('Management/Reports/Tender');
...
if($request->project_id){
            ...
            $data = $data->whereIN('id', $request->project_id);
        }
        ...
        return response()->json(['data' => $data, 'bid_value' => $bid_value]);
    }
    ...
    {
        return Inertia::render('Management/Reports/Procurement');
