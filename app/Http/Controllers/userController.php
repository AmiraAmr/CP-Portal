...
class userController extends Controller
{
    ...
    public function jsonUser(request $request)
    {
        ...
        $data = $data->with('role')->orderBy('created_at', 'DESC')->paginate($request->size);
    ...
    public function rig()
    {
        ...
        return Inertia::render('Management/Users/Create', ['projects' => $projects, 'roles' => $roles]);
    ...
    public function edit(User $User)
    {
        ...
        return Inertia::render('Management/Users/Edit', ['projects' => $projects, 'roles' => $roles, 'data' => $User]);
    ...
    public function usertable()
    {
        ...
        return Inertia::render('Management/Users/Index', ['projects' => $projects, 'roles' => $roles]);
    ...
    public function add(request $request)
    {
        ...
        return redirect()->route('user.usertable', ['message' => 'Created successfully']);
    }
    public function update(request $request, User $User)
    {
        ...
        return redirect()->route('user.usertable', ['message' => 'Modified successfully']);
    }
