...
class tenderController extends Controller
{
    ...
    public function index(request $request)
    {
        ...
        return Inertia::render('User/Tender/Index', ['data' => $data]);
    }
    ...
    public function update(marketing $marketing)
    {
        ...
        return Inertia::render('User/Tender/Edit', ['data' => $marketing]);
    }
    ...
    public function responses(request $request, marketing $marketing)
    {
        ...
        $monthly_section =     $section->monthly_section()->select([
            'id', 'num_marketing_project',
            'section_id'
        ])
        ...
        return redirect()->route('tender.index', ['message' => 'Modified successfully']);
