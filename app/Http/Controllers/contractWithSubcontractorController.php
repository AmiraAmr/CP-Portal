...
class contractWithSubcontractorController extends Controller
{
    ...
    public function preview($contract_withsubcontractor)
    {
        ...
        if (is_numeric($contract_withsubcontractor)) {
            ...
            if (!empty($data)) {
                return Inertia::render('User/SubContractor/Preview', ['data' => $data]);
    ...
    public function updating(request $request, contract_withsubcontractor $contract_withsubcontractor)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request, $data, $contract_withsubcontractor) {
                ...
                return redirect()->route('user.index_CWS', ['message' => 'Modified successfully']);
            });
        } catch (Exception $e) {
            return $e;
        }
    ...
    public function index()
    {
        ...
        return Inertia::render('User/SubContractor/Index', ['data' => $data, 'workflow' => $cwsworkflow]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('User/SubContractor/Create', ['reference' => 'C-' . '' . $explode[1] + 1, 'projects' => $projects]);
    }
    ...
    public function contract_withsubcontractorinsrting(request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request) {
                ...
                return redirect()->route('user.index_CWS', ['message' => 'Created successfully']);
            });
        } catch (Exception $e) {
            return $e;
        }
