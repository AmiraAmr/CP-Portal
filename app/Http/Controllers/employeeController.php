...
class employeeController extends Controller
{
    ...
    public function insrting(request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request, $data) {
                ...
                return redirect()->route('user.index_employee_inv', ['message' => 'Created successfully']);
            });
        } catch (Exception $e) {
            return $e;
        }
    ...
    public function preemployeereturn(request  $request)
    {
        ...
        return Inertia::render('User/EmployeeRequest/Preview');
    ...
    public function employeereturn($employee)
    {
        if (is_numeric($employee)) {
            ...
            if (!empty($data)) {
                ...
                return view('employee.preview')->with(['dataFromController' => $data]);
            }
        }
    }
