...
class subcontractorController extends Controller
{
    ...
    public function Archives()
    {
        ...
        return Inertia::render('User/Archives/Index', ['data' => $data, 'workflow' => $cwsworkflow]);
    ...
    public function updating(request $request, subcontractor $subcontractor)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request, $data, $subcontractor) {
                ...
                return redirect()->route('user.index_subcontractor_inv', ['message' => 'Modified successfully']);
            });
        } catch (Exception $e) {
            return $e;
        }
    ...
    public function index(contract_withsubcontractor $contract_withsubcontractor)
    {
        ...
        if (is_numeric($contract_withsubcontractor->id) && $contract_withsubcontractor->status == 1 || is_numeric($contract_withsubcontractor->id) && $contract_withsubcontractor->status == 2) {
    ...
    public function subcontractorinsrting(request $request, $contract_withsubcontractor)
    {
        ...
        $data = json_encode($errors);
                ...
                */
                ...
                return redirect()->route('user.index_subcontractor_inv', ['message' => 'Created successfully']);
    ...
    public function subcontractorreturn($subcontractor)
    {
        if (is_numeric($subcontractor)) {
            ...
            if (!empty($data)) {
                return Inertia::render('User/Archives/Preview', ['data' => $data,]);
