...
class JobOfferController extends Controller
{
    ...
    {
        return Inertia::render('User/JobOffer/Preview');
    ...
    public function index()
    {
        ...
        $data =  auth()->user()->joboffer()->latest()
            ->with(['joboffer_cycle' => function ($q) {
                return   $q->with('role');
            }])->paginate(10);
    ...
    public function create()
    {
        ...
        return Inertia::render('User/JobOffer/Create', ['reference' => 'Jo-' . '' . $explode[1] + 1]);
    }
    ...
    public function insert(request $request)
    {
        ...
        */
        ...
        return redirect()->route('user.joboffer.index', ['message' => 'Created successfully']);
    ...
    public function preview($joboffer)
    {
        if (is_numeric($joboffer)) {
            ...
            if ($data) {
                return Inertia::render('User/JobOffer/Preview', ['dataFromController' => $data]);
    ...
    public function update($joboffer)
    {
        ...
        if (is_numeric($joboffer)) {
            ...
            if ($data) {
                return Inertia::render('User/JobOffer/Edit', ['data' => $data]);
