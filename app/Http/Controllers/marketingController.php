...
class marketingController extends Controller
{
    public function add(request $request)
    {
        ...
        $user =   auth()->user();
        if (
            $update !== null  && !empty($user->role) && !empty($user->role->section)  &&
        ...
        if (
            !empty($user->role) && !empty($user->role->section)  &&
            $user->role->section->name == 'Marketing'
        ) {
        ...
        return redirect()->route('marketing.index.user', ['message' => 'Created successfully']);
    }


    public function index()
    {
        $data = marketing::with('user');


        $data = $data->orderBy('created_at', 'DESC')->paginate(20);
        return Inertia::render('User/Marketing/Index', ['data' => $data]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('User/Marketing/Create', ['reference' => 'M-' . '' . $explode[1] + 1,]);
    ...
    public function edit($marketing)
    {
        ...
        if (is_numeric($marketing)) {
            ...
            if ($data) {
                return Inertia::render('User/Marketing/Edit', ['data' => $data]);
    ...
    public function update(request $request, marketing $marketing)
    {
        ...
        return redirect()->route('marketing.index.user', ['message' => 'Modified successfully']);
    }
