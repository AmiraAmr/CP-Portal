...
class contractorController extends Controller
{
    ...
    public function addcpage()
    {
        ...
        return Inertia::render('Management/Contractors/Create');
    ...
    public function index()
    {
        ...
        return Inertia::render('Management/Contractors/Index', [
            'data' => $pr,
        ]);
    ...
    {
        return Inertia::render('Management/Contractors/Edit', [
            'data' => $contractor,
        ]);
