...
class managersMatrialrequestController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Management/MatrialRequest/Index', [
    ...
    public function matrial_requestreturn($matrial_request)
    {
        if (is_numeric($matrial_request)) {
            ...
            if (!empty($data)) {
                return Inertia::render('Management/MatrialRequest/Preview', ['dataFromController' => $data,]);
    ...
    public function updatematrial_requestreturn($matrial_request)
    {
        if (is_numeric($matrial_request)) {
            ...
            if (!empty($data)) {
                ...
                return Inertia::render('Management/MatrialRequest/Edit', [
                    'data' => $data,
                    'projects' => $projects
                ]);
