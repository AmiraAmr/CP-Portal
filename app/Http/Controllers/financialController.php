...
class financialController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Management/FinancialReport/Index', ['users' => $users]);
        ...
        if (is_numeric($financial_daily_report)) {
            ...
            if ($data) {
                ...
                $allowed = auth()->user()->role && auth()->user()->role->name   == 'General Manager' ||
                    ...
                    ?  1 : 0;
                return Inertia::render('Management/FinancialReport/Edit', ['data' => $data, 'allowed' => $allowed]);
    ...
    public function preview($financial_daily_report)
    {
        if (is_numeric($financial_daily_report)) {
            ...
            if ($data) {
                return Inertia::render('Management/FinancialReport/Preview', ['data' => $data]);
    ...
    public function confirm(financial_daily_report $financial_daily_report, request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($financial_daily_report, $request) {
                ...
                daily_financial_report_item::upsert(
                    $update,
                    [
                        'id',
            ...
            return redirect()->route('daily.financial_index', ['message' => 'Modified successfully']);
