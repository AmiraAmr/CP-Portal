...
class managerpurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return Inertia::render('Management/PurchaseOrder/Index', ['projects' => $projects, 'users' => $users]);
    ...
    public function returnjsonpurchase(request $request)
    {
        ...
        $query = new query;
        $Purchase_order = $query->Qindex(   auth()->user()->role , $request , 'manager_cycle_table');
    ...
    public function purchasereturn($Purchase_order)
    {
        if (is_numeric($Purchase_order)) {
            ...
            if (!empty($data)) {
                return Inertia::render('Management/PurchaseOrder/Preview', ['data' => $data]);
            }
        }
    }
    ...
    public function update($Purchase_order)
    {
        if (is_numeric($Purchase_order)) {
            ...
            if (!empty($data)) {
                ...
                return Inertia::render('Management/PurchaseOrder/Edit', [
                    'data' => $data,
                    'suppliers' => $suppliers,
                    'projects' => $projects
                ]);
