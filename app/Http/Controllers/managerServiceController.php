...
class managerServiceController extends Controller
{
    ...
    public function edit($service)
    {
        ...
        if (is_numeric($service)) {
            ...
            if (!empty($data)) {
                $roles = role::get();
                return Inertia::render('Management/Services/Edit', ['data' => $data, 'roles' => $roles]);
    ...
    public function action(request $request, service $service)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request, $data, $service) {
                ...
                return redirect()->route('manager.service.index', ['message' => 'Modified successfully']);
            });
        } catch (Exception $e) {
            return $e;
        }
    ...
    public function preview($service)
    {
        if (is_numeric($service)) {
            ...
            if (!empty($data)) {
                return Inertia::render('Management/Services/Preview', ['data' => $data]);
