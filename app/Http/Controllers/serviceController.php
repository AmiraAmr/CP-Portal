...
class serviceController extends Controller
{
    ...
    public function edit($service)
    {
        ...
        if (is_numeric($service)) {
            ...
            if (!empty($data)) {
                $roles = role::get();
                return Inertia::render('User/Services/Edit', ['data' => $data, 'roles' => $roles]);
    ...
    public function update(request $request, service $service)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request, $data, $service) {
                ...
                return redirect()->route('user.service.index', ['message' => 'Modified successfully']);
            });
        } catch (Exception $e) {
            return $e;
        }
    ...
    public function index()
    {
        ...
        return Inertia::render('User/Services/Index', ['data' => $service, 'workflow' => $serviceworkflow,]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('User/Services/Create', ['reference' => 'HR-' . '' . $explode[1] + 1, 'roles' => $roles]);

        return view('service.create')->with(['reference' => 'HR-' . '' . $explode[1] + 1, 'roles' => $roles]);
    }
    ...
    public function insrting(request $request)
    {
        ...
        try {
            ...
            DB::transaction(function () use ($request, $data) {
                ...
                return redirect()->route('user.service.index', ['message' => 'Created successfully']);
            });
        } catch (\Exception $e) {
    ...
    public function servicereturn($service)
    {
        if (is_numeric($service)) {
            ...
            if (!empty($data)) {
                return Inertia::render('User/Services/Preview', ['dataFromController' => $data]);
