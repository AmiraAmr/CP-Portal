...
class ManagerJobOfferController extends Controller
{
    ...
    {
        return Inertia::render('Management/JobOffer/Index');
    }
    ...
    public function updating(request $request, joboffer $joboffer)
    {
        ...
        return redirect()->route('manager.joboffer.index', ['message' => 'Modified successfully']);
    }
    ...
    public function preview($joboffer)
    {
        if (is_numeric($joboffer)) {
            ...
            if ($data) {
                return Inertia::render('Management/JobOffer/Preview', ['dataFromController' => $data]);
    ...
    public function update($joboffer)
    {
        ...
        if (is_numeric($joboffer)) {
            ...
            if ($data) {
                return Inertia::render('Management/JobOffer/Edit', ['data' => $data]);
