...
class contractor_employee extends Controller
{
    ...
    public function contractor(request $request)
    {
        ...
        return redirect()->route('user.contractorindex', ['message' => 'Created successfully']);
    }
    public function addcpage()
    {

        return Inertia::render('User/Contractors/Create');
    ...
    public function index()
    {
        ...
        $pr = contractor::latest()->paginate(10);
        return Inertia::render('User/Contractors/Index', [
            'data' => $pr,
        ]);
    }
    ...
    {
        return Inertia::render('User/Contractors/Edit', [
            'data' => $contractor,
        ]);
    }
    ...
    public function updatecontractor(request $request, contractor $contractor)
    {
        ...
        return redirect()->route('user.contractorindex', ['message' => 'Modified successfully']);
    }
}
