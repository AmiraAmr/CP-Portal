...
const Create = (props) => {
    ...
    const submit = () => {
        ...
        if (data.percentage_cash_flow) {
            formData.append("percentage_cash_flow", data.percentage_cash_flow);
        }
        if (data.percentage_deal) {
            formData.append("percentage_deal", data.percentage_deal);
        }
        if (data.percentage_performance) {
            formData.append(
                "percentage_performance",
                data.percentage_performance
            );
        }
        if (data.percentage_attendance) {
            formData.append(
                "percentage_attendance",
                data.percentage_attendance
            );
        }
        if (data.marketing_project) {
        ...
        router.post("/managers/department/insert", formData);
    };
