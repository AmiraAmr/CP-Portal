...
const Edit = (props) => {
    const [checked, setChecked] = useState(props.data.on_vat ? true : false);
    const [cash, setCash] = useState(props.data.cash);
    const [vat, setVat] = useState(0);
    const { Dragger } = Upload;
    const [fileList, setFileList] = useState(props.data.files);

    const [products, setProducts] = useState({ id: 0, data: [] });

    const [discount, setDiscount] = useState(props.data.percentage_discount);
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        ref: props.data.ref,
        total: props.data.subtotal,
        subject: props.data.subject,
        after_discount: props.data.total,
        discount_total: 0,
        overall: 0,
    });
    ...
    const submit = () => {
        ...
        router.post(`/pricing_supplierupdate/${props.data.id}`, formData);
    };
    ...
    }, [props.data.attributes2, props.data.attributes]);
