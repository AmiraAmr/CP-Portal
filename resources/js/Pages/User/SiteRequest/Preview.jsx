    ...
    return (
        <div>
            ...
            <div className="container" id="printMe">
                ...
                <div className="row">
                    {data.site_cycle?.map((data, index) => {
                        return (
                            <div
                                key={data.id}
                                className="col-2"
                                v-for="data in data.site_cycle"
                            >
                                {data.comment_site_cycle && data.status == 1 ? (
                                    <div className="col-2">
                                        <img
                                            src={`/uploads/sign/${data.comment_site_cycle.user.sign}`}
                                            alt=""
                                            width="80"
                                        />
                                    </div>
                                ...
                                {data.comment_site_cycle && data.status == 2 ? (
                                    <div className="col-2">
