        ...
        <div>
            ...
            <div className="container" id="printMe">
                ...
                <div className="qr row pt-4 pb-4">
                    <div className="col-6">
                        <QRCode
                            value={routeFromController ? routeFromController : ""}
                            renderAs="canvas"
                            size="90"
                        />
                    </div>
                ...
                <div className="row">
                    {data?.rfq_cycle?.map((data) => {
                        return (
                            <div
                                key={data?.id}
                                className="col-2"
                                v-for="data in data?.rfq_cycle"
                            >
                                {data?.comment_rfq_cycle && data?.status == 1 ? (
                                    <div className="col-2">
                                        <img
                                            src={`/uploads/sign/${data?.comment_rfq_cycle.user.sign}`}
                                            alt=""
                                            width="80"
                                        />
                                    </div>
                                ...
                                {data?.comment_rfq_cycle && data?.status == 2 ? (
                                    <div className="col-2">
