...
const Edit = (props) => {
    ...
    const [totalAmount, setTotalAmount] = useState(props.data.total);
    const [vat, setVat] = useState(props.data.vat);
    const [includedVat, setIncludedVat] = useState(props.data.no_vat ? props.data.no_vat : false);
    ...
    const [files, setFiles] = useState(props.data.petty_cash_attachment);
    ...
    const submit = () => {
        if (totalpoExpenses <= tablePrices.po_budget) {
            ...
            router.post(`/user/petty_cash_update/${props.data.id}`, formData);
        }
    };
    useEffect(() => {
    ...
    return (
        <AuthenticatedLayout auth={props.auth} errors={props.errors}>
            <div className="space-y-2">
                ...
                <div className="bg-white p-4 rounded-md dail-report">
