...
const Navbar = ({ auth }) => {
    ...
    return (
        <>
                    ...
                    <div className="flex justify-between h-20 items-center">
                        ...
                        <div className="hidden lg:flex lg:items-center lg:mr-6 space-x-3">
                            ...
                            <div className="relative">
                                ...
                                <div
                                    className="w-10 h-10 rounded-full flex items-center justify-center group hover:bg-sky-50"
                                    onClick={() =>
                            ...
                            <div className="flex items-center gap-2 px-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        {auth?.user?.manager == 1 ? (
                                            <Dropdown.Link href="/managers/index_purchase_order">
                                                Managment
                                            </Dropdown.Link>
                                        ) : null}
            ...
            <Notifications
                isOpen={showingNotifications}
                setIsOpen={setShowingNotifications}
            />
        </>
    );
};
